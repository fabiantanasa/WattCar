...
<title>WattCar - Rezultatul Căutării</title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Rezultatul căutării după cuvântul cheie "<?php echo $_POST['searchdata'];?>"</h1>
      </div>
...
where tblvehicles.VehiclesTitle=:search || tblvehicles.VehicleType=:search || tblbrands.BrandName=:search || tblvehicles.ModelYear=:search";
...
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?> Rezultate găsite pentru tine</span></p>
</div>
</div>
        ...
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <ul>
              ...
              <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear);?> An fabricație</li>
              <li><i class="fa fa-car" aria-hidden="true"></i><?php echo htmlentities($result->VehicleType);?></li>
            </ul>
            <a href="vehicle-details.php?vhid=<?php echo htmlentities($result->id);?>" class="btn">Vezi detalii <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
          </div>
        </div>
      <?php }} ?>
         </div>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <br><br>
            <h5><i class="fa fa-car" aria-hidden="true"></i> Mașini adăugate recent</h5>
          </div>
...
{  ?>
              ...
              <li class="gray-bg">
                ...
                <div class="recent_post_title"> <a href="vehicle-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?>  <?php echo htmlentities($result->VehiclesTitle);?></a>
                  <p class="widget_price"><?php echo htmlentities($result->PricePerDay);?> RON/zi</p>
                </div>
              </li>
              <?php }} ?>
