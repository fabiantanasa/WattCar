...
<title>WattCar? - Profilul meu</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Setări Generale</h5>
          <?php  
         if($msg){?><div class="succWrap"><strong>SUCCES</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
              <label class="control-label">Data înregistrării  -</label>
             <?php echo htmlentities($result->RegDate);?>
            </div>
             <?php if($result->UpdationDate!=""){?>
            <div class="form-group">
              <label class="control-label">Ultima actualizare la  -</label>
            ...
            <div class="form-group">
              <label class="control-label">Data nașterii &nbsp;(zz/ll/aaaa)</label>
            ...
            <div class="form-group">
              <label class="control-label">Țara</label>
            ...
            <div class="form-group">
              <button type="submit" name="updateprofile" class="btn">Salvează schimbările <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
