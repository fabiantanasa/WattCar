...
$msg="Imagine modificată cu succes";
...
<head>
	...
	<title>WattCar - Admin Schimbare Imaginea 4</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Imaginea 4 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Imaginea 4</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Imaginea curentă</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Adaugă o nouă imagine<span style="color:red">*</span></label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="update" type="submit">Actualizează</button>
												</div>
											</div>
