...
$msg="Rezervare anulată cu succes!";
}
...
$msg="Rezervare confirmată cu succes!";
}
...
<head>
	...
	<title>WattCar - Administrare Rezervări   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gestionează Rezervările</h2>
...
echo htmlentities('Confirmată');
 	...
 	echo htmlentities('Anulată');
										...
										<td><a href="manage-bookings.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Doriți să confirmați această rezervare?')"> Confirmă</a> /


<a href="manage-bookings.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Doriți să anulați această rezervare?')"> Anulează</a>
</td>
