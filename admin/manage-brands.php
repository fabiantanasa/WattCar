...
<head>
	...
	<title>WattCar - Administrare Branduri   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gestionează Brand</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Branduri listate</div>
...
<a href="manage-brands.php?del=<?php echo $result->id;?>" onclick="return confirm('Doriți să ștergeți?');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
