...
$query -> execute();
$msg="Informații abonat șterse cu succes";
...
<head>
	...
	<title>WattCar -  Administrare Abonați   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gestionare abonați</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Detalii abonați</div>
...
<a href="manage-subscribers.php?del=<?php echo $result->id;?>" onclick="return confirm('Doriți să ștergeți?');"><i class="fa fa-close"></i></a>
</td>
