...
<head>
	...
	<title>WattCar - Rezervări confirmate   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Rezervări confirmate</h2>
...
<a href="bookig-details.php?bid=<?php echo htmlentities($result->id);?>"> Vezi</a>
</td>
