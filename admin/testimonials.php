...
$msg="Recenzie dezactivată cu succes";
}
...
$msg="Recenzie activată cu succes";
}
...
<head>
	...
	<title>WattCar - Administrare Recenzii   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gestionare recenzii</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Recenzii clienți</div>
...
{
	?><a href="testimonials.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Doriți să activați?')"> Dezactivată</a>
<?php } else {?>

<a href="testimonials.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Doriți să dezactivați?')"> Activată</a>
</td>
<?php } ?></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
