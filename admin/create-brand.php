...
if($lastInsertId)
{
$msg="Brand adăugat cu succes";
}
else 
{
$error="Ceva nu a funcționat. Încercați din nou!";
}
...
<head>
	...
	<title>WattCar - Adăugare Brand</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Adaugă brand</h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Adaugă brand</div>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>EROARE</strong>: <?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Nume Brand</label>
												<div class="col-sm-8">
