...
$query->execute();
$msg="Informații actualizate cu succes";
}
?>
...
<head>
	...
	<title>WattCar - Actualizare Informații</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Actualizare Informații</h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Actualizare Informații</div>
...
{				?>	
				...
				<div class="form-group">
												<label class="col-sm-4 control-label"> Adresă</label>
												<div class="col-sm-8">
...
<div class="form-group">
												<label class="col-sm-4 control-label"> Număr de telefon </label>
												<div class="col-sm-8">
...
<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="submit" type="submit">Actualizează</button>
												</div>
											</div>
