...
$error="Parola actuală introdusă este incorectă";	
}
}
?>
...
<head>
	...
	<title>WattCar - Admin Schimbare Parolă</title>
				...
				<div class="row">
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>EROARE</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Parola actuală</label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Noua parolă</label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="submit" type="submit">Schimbă parola</button>
												</div>
											</div>
