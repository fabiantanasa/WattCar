...
if($lastInsertId)
{
$msg="Recenzie trimisă cu succes! ";
}
else 
{
...
<title>WattCar? - Scrie o recenzie</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Scrie o recenzie</h5>
          ...
          <form  method="post">
            ...
            <div class="form-group">
              <button type="submit" name="submit" class="btn">Salvează  <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
