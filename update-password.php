...
$chngpwd1->execute();
$msg="Parola a fost actualizată cu succes";
}
else {
$error="Ați introdus parola actuală greșit!";  
}
}
...
<title>WattCar - Schimbă parola</title>
<!--Bootstrap -->
...
{
alert("Noua parolă nu corespunde cu confirmarea acesteia !");
...
<form name="chngpwd" method="post" onSubmit="return valid();">
            ...
            <div class="form-group">
              <label class="control-label">Parola curentă</label>
            ...
            <div class="form-group">
              <label class="control-label">Confirmă parola</label>
              <input class="form-control white_bg" id="confirmpassword" type="password" name="confirmpassword"  required>
            </div>
          
            <div class="form-group">
               <input type="submit" value="Schimbă parola" name="updatepass" id="submit" class="btn btn-block">
            </div>
          </form>
        </div>
      </div>
